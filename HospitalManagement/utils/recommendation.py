...
class RecommendDoctor:
    ...
    def get_cosine_similarities(self,vec2):
        similarities = []
        with open("/home/suman/Desktop/Doctor-recommendation-system/HospitalManagement/datasets/updated_training_data.csv") as file_obj:
...
#     res = d.give_disease(input_text, 10)
#     print(res)